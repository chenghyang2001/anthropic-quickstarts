...
**Testing Approach:**
- All tests MUST use browser automation via puppeteer tools
- Start each test with puppeteer_navigate to a fresh browser session
- Never use puppeteer_connect_active_tab (always start fresh)
- Use puppeteer_screenshot to verify visual appearance
- Use puppeteer_click, puppeteer_fill, puppeteer_select, puppeteer_hover for interactions
- Only use puppeteer_evaluate for debugging, never as a shortcut
